...
export const elements: Element[] = [
    ...
    // Period 2
    { number: 3, symbol: 'Li', name: 'Lithium', mass: 6.941, category: 'Alkali Metal', ...getPos(2, 1) },
    { number: 4, symbol: 'Be', name: 'Beryllium', mass: 9.0122, category: 'Alkaline Earth Metal', ...getPos(2, 2) },
    { number: 5, symbol: 'B', name: 'Boron', mass: 10.811, category: 'Metalloid', ...getPos(2, 13) },
    ...
    { number: 14, symbol: 'Si', name: 'Silicon', mass: 28.086, category: 'Metalloid', ...getPos(3, 14) },
    ...
    { number: 17, symbol: 'Cl', name: 'Chlorine', mass: 35.453, category: 'Halogen', ...getPos(3, 17) },
    ...
    { number: 22, symbol: 'Ti', name: 'Titanium', mass: 47.88, category: 'Transition Metal', ...getPos(4, 4) },
    ...
    { number: 26, symbol: 'Fe', name: 'Iron', mass: 55.847, category: 'Transition Metal', ...getPos(4, 8) },
    ...
    { number: 30, symbol: 'Zn', name: 'Zinc', mass: 65.39, category: 'Transition Metal', ...getPos(4, 12) },
    { number: 31, symbol: 'Ga', name: 'Gallium', mass: 69.723, category: 'Post-Transition Metal', ...getPos(4, 13) },
    { number: 32, symbol: 'Ge', name: 'Germanium', mass: 72.61, category: 'Metalloid', ...getPos(4, 14) },
    { number: 33, symbol: 'As', name: 'Arsenic', mass: 74.922, category: 'Metalloid', ...getPos(4, 15) },
    { number: 34, symbol: 'Se', name: 'Selenium', mass: 78.96, category: 'Non-Metal', ...getPos(4, 16) },
    ...
    { number: 47, symbol: 'Ag', name: 'Silver', mass: 107.868, category: 'Transition Metal', ...getPos(5, 11) },
    ...
    { number: 50, symbol: 'Sn', name: 'Tin', mass: 118.710, category: 'Post-Transition Metal', ...getPos(5, 14) },
    { number: 51, symbol: 'Sb', name: 'Antimony', mass: 121.757, category: 'Metalloid', ...getPos(5, 15) },
    { number: 52, symbol: 'Te', name: 'Tellurium', mass: 127.60, category: 'Metalloid', ...getPos(5, 16) },
    { number: 53, symbol: 'I', name: 'Iodine', mass: 126.904, category: 'Halogen', ...getPos(5, 17) },
    ...
    { number: 56, symbol: 'Ba', name: 'Barium', mass: 137.327, category: 'Alkaline Earth Metal', ...getPos(6, 2) },
    { number: 57, symbol: 'La', name: 'Lanthanum', mass: 138.91, category: 'Lanthanide', ...getPos(6, 3) },
    ...
    { number: 79, symbol: 'Au', name: 'Gold', mass: 196.967, category: 'Transition Metal', ...getPos(6, 11) },
    ...
    { number: 83, symbol: 'Bi', name: 'Bismuth', mass: 208.980, category: 'Post-Transition Metal', ...getPos(6, 15) },
    { number: 84, symbol: 'Po', name: 'Polonium', mass: 208.982, category: 'Metalloid', ...getPos(6, 16) },
    { number: 85, symbol: 'At', name: 'Astatine', mass: 209.987, category: 'Halogen', ...getPos(6, 17) },
    { number: 86, symbol: 'Rn', name: 'Radon', mass: 222.018, category: 'Noble Gas', ...getPos(6, 18) },
    ...
    { number: 92, symbol: 'U', name: 'Uranium', mass: 238.029, category: 'Actinide', ...getPos(10, 5) },
