...
import { Atom, Scale, Sigma, ArrowRight, Beaker, Wind, FlaskConical } from 'lucide-react';
...
export default function HomePage() {
  return (
    <AnimatedBackground>
      {/* Hero Section */}
      <div className="relative max-w-4xl mx-auto text-center py-16 lg:py-24 px-6">
        ...
        <p className="text-lg md:text-xl text-slate-600 max-w-2xl mx-auto mb-10 leading-relaxed">
          Stop struggling with manual calculations. Use this interactive toolkit to solve for molar mass, balance chemical equations, perform stoichiometry, and find limiting reactants.
        </p>
      ...
      {/* Features Grid - Updated to 2 columns */}
      <div className="relative max-w-6xl mx-auto px-6 pb-20">
        <div className="grid md:grid-cols-2 gap-6">
          ...
          {/* Card 4: Limiting Reactant */}
          <Link href="/limiting-reactant" className="group bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-sm border border-slate-200 hover:shadow-md hover:border-rose-200 transition-all flex flex-col">
          ...
          {/* Card 6: Molarity */}
          <Link href="/molarity" className="group bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-sm border border-slate-200 hover:shadow-md hover:border-emerald-200 transition-all flex flex-col">
            <div className="p-3 bg-emerald-50 text-emerald-600 rounded-xl w-fit mb-4 group-hover:scale-110 transition-transform">
              <FlaskConical size={24} />
            </div>
            <h3 className="text-lg font-bold text-slate-800 mb-2">Molarity Calculator</h3>
            <p className="text-slate-500 text-sm leading-relaxed flex-grow">
              Calculate molarity, moles, volume, or mass for solution chemistry problems
            </p>
